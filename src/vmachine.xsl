  ...
  "true" to "false" below -->
   ...
   <xsl:template name="manuscriptPanel">
      ...
      <div>
         ...
         <div class="panelBanner">
            ...
            <img class="closePanel" src="../vm-images/Close Button.svg" alt="X (Close panel)" />
   ...
   <xsl:template match="/tei:TEI/tei:teiHeader/tei:fileDesc">
      <div class="panel" id="bibPanel">
         ...
         <div class="panelBanner">
            <img class="closePanel" onclick="toggleBiblio();" alt="X (Close panel)" src="../vm-images/Close Button.svg" />
   ...
   <xsl:template name="imageLink">
      ...
      <xsl:if test="$imageURL != ''">
         <img src="../vm-images/New Picture Button.svg" alt="Facsimile Image Placeholder">
            <xsl:attribute name="class">
   ...
   <xsl:template name="imageViewer">
      <div class="viewerRoot" id="panel_imageViewer">
         <div title="Click to drag panel." class="viewerHandle" id="handle_imageViewer">
            ...
            <img class="viewerHandleRt" onclick="return hidePanel('imageViewer');" alt="X" src="../vm-images/Close Button.svg" />
         </div>
